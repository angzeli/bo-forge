"""Canonical campaign schema and staged row validation."""
...
from bo_forge._campaign.validation_rules import (
    _blank_mask,
    _normalise_design_value,
    _normalise_variable_value,
    _required_bound,
    _validate_constraints,
    _validate_cost_expression,
    _validate_finite_nullable_numeric_columns,
    _validate_nonnegative_nullable_numeric_columns,
    _validate_nullable_numeric_columns,
)
...
VALID_SOURCES = {
    "manual", "random", "sobol", "log_ei", "qlog_ei", "cost_log_ei", "qlog_nei",
    "replicate_uncertain_best", "qmf_kg",
}
VALID_MULTI_OBJECTIVE_SOURCES = {
    "manual", "random", "sobol", "qlog_ehvi", "cost_qlog_ehvi", "qlog_nehvi",
}
