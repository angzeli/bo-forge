...
Contextual BO support allows single-objective `bo.acquisition: log_ei`
...
qLogNEHVI support is deliberately narrow. It is only supported for
...
Multi-fidelity support remains deliberately conservative.
...
BO Forge supports qMFKG batches up to four candidates. Larger batches are
