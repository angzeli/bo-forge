...
BO Forge v2.0.0 provides a local Streamlit workbench around the existing `CampaignSession` workflow.
...
v2.0.0 app support is limited to single-objective contextual LogEI/qLogEI
