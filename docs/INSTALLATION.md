...
This page shows the recommended `pip install` paths for BO Forge v1.3.3.
...
/tmp/bo_forge_probe/bin/pip install dist/bo_forge-1.3.3-py3-none-any.whl
...
/tmp/bo_forge_sdist_probe/bin/pip install dist/bo_forge-1.3.3.tar.gz
