...
This page shows the recommended `pip install` paths for BO Forge v1.1.2.
...
/tmp/bo_forge_probe/bin/pip install dist/bo_forge-1.1.2-py3-none-any.whl
...
/tmp/bo_forge_sdist_probe/bin/pip install dist/bo_forge-1.1.2.tar.gz
