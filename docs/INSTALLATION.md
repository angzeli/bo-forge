...
This page shows the recommended `pip install` paths for BO Forge v2.3.1.
...
/tmp/bo_forge_probe/bin/pip install dist/bo_forge-2.3.1-py3-none-any.whl
...
/tmp/bo_forge_sdist_probe/bin/pip install dist/bo_forge-2.3.1.tar.gz
